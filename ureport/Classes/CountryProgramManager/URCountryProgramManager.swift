...
class URCountryProgramManager: NSObject {
    ...
    class func getAvailableCountryPrograms() -> [URCountryProgram]{
        ...
        if countryPrograms == nil {
            ...
            countryPrograms.append(URCountryProgram(code: "UGA", themeColor: UIColor(rgba: "#d6001f"), org:nil,   name: "Uganda",         twitter:"UReportUganda",facebook:"UReportUganda",rapidProHostAPI: URConstant.RapidPro.API_URL,ureportHostAPI: URConstant.RapidPro.API_NEWS, groupName: "U-Reporters"))
