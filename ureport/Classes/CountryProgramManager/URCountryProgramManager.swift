...
//            countryPrograms.append(URCountryProgram(code: "GBR", themeColor: UIColor(rgba: "#00166B"), org:19,     name: "United Kingdom",      twitter:"UReportThai",facebook:nil,rapidProHostAPI: "https://rapidpro.ilhasoft.mobi/api/v1/",ureportHostAPI: "http://thailand.ureport.in/api/v1/stories/org/", groupName: "U-Reporters"))
