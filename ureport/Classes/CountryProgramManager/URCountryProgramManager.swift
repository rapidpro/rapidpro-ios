...
class URCountryProgramManager: NSObject {
    ...
    class func getAvailableCountryPrograms() -> [URCountryProgram]{
        ...
        if countryPrograms == nil {
            ...
            countryPrograms.append(URCountryProgram(code: "GTM", themeColor: UIColor(rgba: "#3B85C5"), org:7,     name: "Guatemala",        twitter:"UReportGua",facebook:nil,rapidProHostAPI: "https://rapidpro.ilhasoft.mobi/api/v1/",ureportHostAPI: "http://guatemala.ureport.in/api/v1/stories/org/", groupName: "U-Reporters",stateField:"department"))
...
//            countryPrograms.append(URCountryProgram(code: "SYR", themeColor: UIColor(rgba: "#C1001D"), org:6,     name: "Syria",      twitter:nil,facebook:nil,rapidProHostAPI: "https://rapidpro.ilhasoft.mobi/api/v1/",ureportHostAPI: "http://syria.ureport.in/api/v1/stories/org/", groupName: "U-Reporters"))
            countryPrograms.append(URCountryProgram(code: "THA", themeColor: UIColor(rgba: "#1B143E"), org:5,     name: "Thailand",      twitter:"UReportThai",facebook:nil,rapidProHostAPI: "https://rapidpro.ilhasoft.mobi/api/v1/",ureportHostAPI: "http://thailand.ureport.in/api/v1/stories/org/", groupName: "U-Reporters",stateField:"provincy"))
